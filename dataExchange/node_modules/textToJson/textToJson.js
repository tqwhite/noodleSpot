...
=require('./textToJson.js'),
	...
	textToJson=new textToJson(fileName, [definition | 'getFieldNamesFrom']);
...
var moduleFunction = function(fileName, definition) {
		...
		var self = this,
			...
			convert=function(){
qtools.dump({'\n\n===== definition.inputDataFormat =====\n':definition.inputDataFormat});
				if (definition.inputDataFormat==='flattenedJson'){
					multiSpecConversion();
				}
				else{
					simpleConversion();
			...
			multiSpecConversion=function(){
			console.dir(definition);
				qtools.die('multiSpecConversion2');
			},
